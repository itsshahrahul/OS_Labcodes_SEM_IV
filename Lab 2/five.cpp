...
int main() {
    ...
    int completion_time[MAX_PROCESS], remaining[MAX_PROCESS], min_priority_index, time;
    ...
    while (done < num_processes) {
        ...
        if (min_priority_index == -1) {
            ...
            time += remaining[min_priority_index];
            completion_time[min_priority_index] = time;
            remaining[min_priority_index] = 0;
            done++;
        }
    }
